...
!function () {
	var data = [
		...
		{eventName: 'Metagenomics Course', calendar: 'Courses', color: 'yellow' , eventTime: moment("2021-04-17")},

		{eventName: 'Evolution Simposion', calendar: 'Other', color: 'green', eventTime: moment("2021-05-17")},
	];
